        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('button') }}">Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('dropdown') }}">Dropdowns</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="error">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('error_404') }}"> 404 </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('error_500') }}"> 500 </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
